...
- `src/aaps.js` contains the JavaScript parser, serializer, sample script, and Markdown compiler.
...
- `npm run studio`: starts the local Studio plus Codex wrapper at `http://127.0.0.1:8766`.
