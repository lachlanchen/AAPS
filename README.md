...
<div align="center">
  <h1>AAPS</h1>
  <p><strong>Project-oriented programming for agents.</strong></p>
  <p>A prompt-native language and visual studio for turning ideas into structured, executable, and verifiable pipelines.</p>
  <p>
