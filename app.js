...
const WEB_I18N = {
  en: {
    ...
    runtimeTitle: "Parse, compile, plan, execute", runtimeText: "AAPS separates parse, manifest, plan, and execute. Runtime runs local actions, resumes with freshness checks, preserves no-override artifacts, invalidates stale outputs when scripts or inputs change, and pauses for human-review checkpoints.",
  ...
  "zh-Hans": {
    ...
    runtimeTitle: "解析、编译、计划、执行", runtimeText: "AAPS 分离 parse、manifest、plan、execute。运行时会执行本地动作，用新鲜度检查恢复运行，保留 no-override 产物，并在脚本或输入变化时让陈旧输出失效，还能在人工审核点暂停。", examplesTitle1: "类器官示例", examplesTitle2: "应用检查", examplesTitle3: "书籍流水线", examplesTitle4: "CLI", deployTitle: "托管于 aaps.lazying.art", deployText: "仓库通过 website/ 部署 GitHub Pages，并将 Studio 复制到 /studio/。"
  },
