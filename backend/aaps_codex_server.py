...
def block_source_from_chat_payload(block_id: str, message: str, action: dict, validations: list[str], node_kind: str = "block") -> str:
    title = block_id.replace("_", " ").title()
...
def materialize_block_chat(project_dir: Path, block_id: str, message: str, payload: dict, body: dict) -> dict:
    ...
    source = block_source_from_chat_payload(block_id, message, payload.get("action") or {}, payload.get("validations") or [], node_kind)
